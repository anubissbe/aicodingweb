export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Manus Computer': 'Euraika Computer',
  'Manus is using': 'Euraika is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Manus a task to work on...': 'Give Euraika a task to work on...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Manus': 'Login to Euraika-Code',
  'Register to Manus': 'Register to Euraika-Code',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Manus': 'Registration successful! Welcome to Euraika-Code',
  ...
  'You are viewing a completed Manus task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed Euraika task. Replay will start automatically in {countdown} seconds.',
} 